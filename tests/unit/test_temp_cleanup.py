...
class TestCleanupResult:
    ...
    def test_result_size_mb(self):
        ...
        result = CleanupResult(
            deleted_files=["file1.mp4", "file2.mp4"], deleted_size_bytes=10 * 1024 * 1024  # 10 MB
        )
    ...
    def test_result_with_errors(self):
        ...
        result = CleanupResult(errors=["Permission denied: file.mp4"])
...
class TestCleanupTempFiles:
    ...
    def test_cleanup_old_files(self, temp_dir):
        ...
        result = cleanup_temp_files(tmp_dir=tmp_dir, min_age_hours=0)
    ...
    def test_cleanup_preserve_recent(self, temp_dir):
        ...
        result = cleanup_temp_files(tmp_dir=tmp_dir, min_age_hours=1.0)
    ...
    def test_cleanup_preserve_patterns(self, temp_dir):
        ...
        result = cleanup_temp_files(
            tmp_dir=tmp_dir, min_age_hours=0, preserve_patterns=["last_session.json"]
        )
    ...
    def test_cleanup_dry_run(self, temp_dir):
        ...
        result = cleanup_temp_files(tmp_dir=tmp_dir, min_age_hours=0, dry_run=True)
...
class TestCheckDiskSpace:
    ...
    def test_below_threshold(self, temp_dir):
        ...
        warn, auto = check_disk_space(
            tmp_dir=tmp_dir, warn_threshold_gb=10.0, auto_cleanup_threshold_gb=20.0
        )
