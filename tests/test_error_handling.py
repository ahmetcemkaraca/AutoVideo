...
def test_user_message():
    ...
    vr_exc = VideoRendererError(
        message="Test error",
        context=ErrorContext(user_action="Try again")
    )
...
def test_log_context():
    ...
    from video_renderer.logging import request_id_var, component_var
